...
ChatLogic::~ChatLogic() {
  // The destructor will automatically take care of the memory de-allocation of
  // the owned handles in the vector _nodes.
}
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename) {
  ...
  /*Task 5*/
  // local instance of ChatBot constructed 
  ChatBot cb = ChatBot("../images/chatbot.png");
  // setting handles in newly constructed instance of ChatBot
  cb.SetChatLogic(this);
  cb.SetRootNode(rootNode);
  assert(cb.GetRootNode() == rootNode);
  // Moving newly constructed instance of ChatBot to rootNode
...
wxBitmap *ChatLogic::GetImageFromChatbot() { return (_chatBot!=nullptr)?_chatBot->GetImage():nullptr; }
