...
ChatLogic::~ChatLogic()
{
  // The destructor will automatically take care of the memory de-allocation of the owned handles in the vector _nodes.
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    /*Task 5*/
    //local instance of ChatBot constructed by moving from _chatBot
    ChatBot cb=ChatBot(std::move(*_chatBot));
    delete _chatBot;
